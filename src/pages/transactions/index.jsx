...
const Transactions = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Transactions - PortfolioAnalytics Pro</title>
        <meta name="description" content="Manage and track all portfolio transactions including buy, sell, and dividend activities." />
      </Helmet>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onChange={(value) => setFilters(prev => ({...prev, portfolio: value}))}
                    options={[
                ...
                <table className="w-full">
                  <thead className="bg-muted/30">
                    <tr>
                      ...
                      <th className="text-left p-4 text-sm font-medium text-foreground">Security</th>
                      <th className="text-right p-4 text-sm font-medium text-foreground">Quantity</th>
                      <th className="text-right p-4 text-sm font-medium text-foreground">Price</th>
                      <th className="text-right p-4 text-sm font-medium text-foreground">Amount</th>
                      <th className="text-left p-4 text-sm font-medium text-foreground">Portfolio</th>
...
const TransactionModal = ({ isOpen, onClose, onSave, transaction, title }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const transactionData = {
      ...
      amount: (parseFloat(formData.quantity) || 0) * (parseFloat(formData.price) || 0),
          ...
          <div className="bg-muted/30 border border-border rounded-lg p-4">
            ...
            <div className="space-y-1 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-foreground">${(parseFloat(formData.fees) || 0).toFixed(2)}</span>
              </div>
