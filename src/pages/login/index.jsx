...
const Login = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Sign In - PortfolioAnalytics Pro</title>
        ...
        <header className="relative z-10 px-6 py-4">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-white">PortfolioAnalytics</h1>
                <span className="text-sm text-blue-200 font-medium">PRO</span>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
              <div className="text-center md:text-left">
                <p className="text-sm text-blue-200">
                  © {currentYear} PortfolioAnalytics Pro. All rights reserved.
                </p>
