...
const Calendar = () => {
  ...
  const [events, setEvents] = useState([
    {
      ...
      time: '09:00',
      type: 'meeting',
      description: 'Review Q4 performance and discuss rebalancing strategies',
      portfolio: 'Growth Portfolio A',
      attendees: ['John Doe', 'Sarah Wilson']
    },
    {
      id: 2,
      title: 'Earnings Release - AAPL',
      date: '2025-01-30',
      time: '16:00',
      type: 'earnings',
      description: 'Apple Q1 earnings announcement',
    ...
    {
      id: 4,
      title: 'Client Review - Johnson Family',
      date: '2025-02-05',
      time: '10:30',
      type: 'client',
      description: 'Monthly portfolio review and planning session',
      portfolio: 'Conservative Fund B',
      attendees: ['Michael Johnson', 'Lisa Johnson']
    }
  ]);
  ...
  const eventTypes = {
    meeting: { color: 'bg-primary text-primary-foreground', icon: 'Calendar' },
    earnings: { color: 'bg-success text-success-foreground', icon: 'TrendingUp' },
    economic: { color: 'bg-warning text-warning-foreground', icon: 'Building' },
    client: { color: 'bg-accent text-accent-foreground', icon: 'Users' },
    deadline: { color: 'bg-error text-error-foreground', icon: 'Clock' }
  };
  ...
  return (
    <>
      <Helmet>
        <title>Calendar - PortfolioAnalytics Pro</title>
